...
The **current** release is **[v0.12.4](https://github.com/censgate/redact/releases/tag/v0.12.4)**. The latest published REST API comparison report remains [results-20260418-175909.md](results-20260418-175909.md) (captured against v0.8.2); re-run `./scripts/benchmark-comparison.sh` for fresh numbers.
